...
import static com.example.anggarisky.splashtohomeangga.Ac4_Follow_Friend.latitute;
...
//
//                    LatLng latLng1 = new LatLng(6.919700, 79.974256);
//                    markerOptions.position(latLng1);
//                    mMap.addMarker(markerOptions);
//                    mMap.animateCamera(CameraUpdateFactory.newLatLng(latLng1));
//
//                    LatLng latLng2 = new LatLng(6.919636, 79.974234);
//                    markerOptions.position(latLng2);
//                    mMap.addMarker(markerOptions);
//                    mMap.animateCamera(CameraUpdateFactory.newLatLng(latLng2));
//
//                    LatLng latLng3 = new LatLng(6.919503, 79.974224);
...
//                    mMap.animateCamera(CameraUpdateFactory.newLatLng(latLng3));
    ...
    private void animate() {
        TranslateAnimation animation = new TranslateAnimation(-1000, 1200, 0, 0);
