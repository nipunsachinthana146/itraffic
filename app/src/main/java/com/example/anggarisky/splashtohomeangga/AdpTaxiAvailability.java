...
public class AdpTaxiAvailability extends ArrayAdapter<ObjAvailability> {
    ...
    public AdpTaxiAvailability(@NonNull Context context, @SuppressLint("SupportAnnotationUsage") @LayoutRes ArrayList<ObjAvailability> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listItem == null)
            listItem = LayoutInflater.from(mContext).inflate(R.layout.taxiavailableraw, parent, false);
